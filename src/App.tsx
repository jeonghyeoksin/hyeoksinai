...
const FAQ_DATA = [
  ...
  {
    question: '[멤버십] 멤버십 구독 신청은 어떻게 하나요?',
    answer: '상단 메뉴의 "멤버십 구독" 페이지에서 원하시는 플랜을 확인하신 후, 안내된 계좌로 입금하시고 info@nextin.ai.kr로 신청 양식을 보내주시면 코드를 발급해 드립니다.'
  },
  {
    question: '[멤버십] 멤버십 환불 규정은 어떻게 되나요?',
    answer: '디지털 콘텐츠 및 서비스 접근 권한이 부여되는 특성상, 멤버십 코드가 발급되어 사용된 이후에는 원칙적으로 환불이 불가합니다. 결제 전 충분히 검토해 주시기 바랍니다.'
  },
  {
    question: '[컨설팅] 컨설팅은 어떤 방식으로 진행되나요?',
    answer: '컨설팅은 고객님의 상황과 편의에 따라 온라인(Zoom 화상회의) 또는 오프라인으로 진행됩니다. 이메일 문의 시 희망하시는 방식을 남겨주시면 일정과 함께 조율해 드립니다.'
  },
  {
    question: '[컨설팅] 무료 상담은 어떻게 신청하나요?',
    answer: '"컨설팅 문의" 페이지에 안내된 이메일(info@nextin.ai.kr)로 양식에 맞춰 문의를 남겨주시면, 정혁신 대표가 직접 내용을 확인하고 무료 맞춤 상담으로 방향을 잡아드립니다.'
  },
  {
    question: '[대행] 어떤 분야의 대행 업무를 맡길 수 있나요?',
    answer: '블로그 포스팅, SNS 콘텐츠 제작, 상세페이지 기획 등 AI를 활용한 전반적인 마케팅 및 콘텐츠 제작 대행이 가능합니다. 상세한 내용은 문의를 통해 협의 가능합니다.'
  },
  {
    question: '[대행] 대행 비용은 어떻게 산정되나요?',
    answer: '대행 비용은 요청하시는 업무의 범위, 난이도, 기간 등에 따라 맞춤형으로 산정됩니다. 이메일로 상세 내용을 남겨주시면 상담 후 정확한 견적을 안내해 드립니다.'
  },
  {
    question: '[파트너십] 파트너십 수익 정산은 언제 되나요?',
    answer: '매월 1일~말일 수익을 익월 5일에 정산내역 공유 후 익월 10일에 지급해 드립니다.'
  },
  {
    question: '[파트너십] 파트너십은 누구나 참여 가능한가요?',
    answer: '혁신AI를 1회라도 결제하신 분이라면 누구나 참여 가능합니다. 파트너 코드를 발급받아 공유하시면 결제액의 20%를 수익으로 쉐어해 드립니다.'
  }
];
